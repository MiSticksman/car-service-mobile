...
class _$ProfileInfoImpl implements _ProfileInfo {
  const _$ProfileInfoImpl(
      ...
      @JsonKey(name: 'cars') final List<Car>? cars,
  ...
  @override
  String toString() {
    return 'ProfileInfo(id: $id, phone: $phone, phoneVerified: $phoneVerified, email: $email, emailVerified: $emailVerified, name: $name, lastName: $lastName, secondName: $secondName, birthdate: $birthdate, cars: $cars, sex: $sex, age: $age, avatar: $avatar, isNew: $isNew, isSmsSend: $isSmsSend, isEmailSend: $isEmailSend)';
  }
...
abstract class _ProfileInfo implements ProfileInfo {
  const factory _ProfileInfo(
          ...
          @JsonKey(name: 'is_new') final int? isNew,
